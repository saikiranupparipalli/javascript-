...
const code1 = () => {
  //--> instead of typing function before the variable,we will directly put the brackets () and  arrow function =>
  const userName = "saikiran";
  //console.log(this.userName)
};
code1();
...
(() => {
  console.log(this);
})(); //since, it is like only writing "console.log('hey')" inside one new index js, it is treated as written on top level. just like that arrow function is get treated.
